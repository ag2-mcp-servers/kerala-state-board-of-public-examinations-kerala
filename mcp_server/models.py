...
#   timestamp: 2025-06-28T15:17:25+00:00
...
class CertificateParameters(BaseModel):
    ...
    regno: str = Field(..., description='Register Number', examples=['123456'])
    year: str = Field(..., description='Year', examples=['2018,2019,2020'])
...
class SslcrCertificatePostRequest(BaseModel):
...
class SslcrCertificatePostResponse(BaseModel):
...
class SslcrCertificatePostResponse1(BaseModel):
...
class SslcrCertificatePostResponse2(BaseModel):
...
class SslcrCertificatePostResponse3(BaseModel):
...
class SslcrCertificatePostResponse4(BaseModel):
...
class SslcrCertificatePostResponse5(BaseModel):
...
class SslcrCertificatePostResponse6(BaseModel):
